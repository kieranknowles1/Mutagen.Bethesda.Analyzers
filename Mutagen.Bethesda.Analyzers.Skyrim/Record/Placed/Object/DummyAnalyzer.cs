...
public class DummyAnalyzer : IContextualRecordAnalyzer<IPlacedObjectGetter>
{
    ...
    public void AnalyzeRecord(ContextualRecordAnalyzerParams<IPlacedObjectGetter> param)
    {
        ...
        var hasLeveledList = !placedObject.LeveledItemBaseObject.IsNull;
        var isDummyItem = placedObject.Base.TryResolve<IItemGetter>(param.LinkCache, out var baseItem) && baseItem is IKeywordedGetter<IKeywordGetter> keyworded && keyworded.HasKeyword(FormKeys.SkyrimSE.Skyrim.Keyword.Dummy);
